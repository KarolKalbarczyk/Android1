...
class MainActivity : AppCompatActivity() {
    ...
    fun count(view: View) {
        binding.apply {
            ...
            else if (height == null) heightET.error = getError(R.string.not_in_range).interpolate(0.0, getMaxHeight())
            else if (height == 0.0) heightET.error = getError(R.string.val_is_zero)
